...
C<futago#git_commit([params])>                               X<futago#start_chat>
...
=item [prompt]: Default is L<here|https://github.com/yukimemi/futago.vim/blob/main/denops/futago/consts.ts#L17>.
